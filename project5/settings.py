# All of the code for this project is based on Code Institute's walk-through Boutique Ado
"""
...
MESSAGE_STORAGE = 'django.contrib.messges.storage.session.SessionStorage'
