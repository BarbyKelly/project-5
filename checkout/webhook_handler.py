        ...
        while attempt <= 5:
            try:
                order = Order.objects.get(
                    ...
                    first_address_line__iexact=shipping_details.address.first_address_line,
                    second_address_line__iexact=shipping_details.address.second_address_line,
        ...
        if order_exists:
            ...
            try:
                order = Order.objects.create(
                    ...
                    first_address_line=shipping_details.address.first_address_line,
                    second_address_line=shipping_details.address.second_address_line,
